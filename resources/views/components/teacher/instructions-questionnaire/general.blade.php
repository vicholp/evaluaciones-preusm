...
<div class="flex flex-col gap-5">
  <div class="flex flex-col gap-4 border-2 border-black border-opacity-50 px-10 py-5">
    ...
    <h3 class="my-3 text-center font-bold">
      INSTRUCCIONES
    </h3>
    ...
    <ol class="flex list-decimal flex-col gap-1">
      ...
      <li>
        Las respuestas a las preguntas se marcan en la hoja de respuestas que se te entregó. Marca tu respuesta en la
        fila
        de celdillas <b> que corresponda al número de la pregunta que estás contestando. </b> Ennegrece completamente la
        celdilla, tratando de no salirte de sus márgenes. Hazlo <b>exclusivamente</b> con lápiz de grafito Nº 2 o
        portaminas HB.
      </li>
      <li>
      ...
      <li>
        Cuida la hoja de respuestas. <b>No la dobles. No la manipules innecesariamente.</b> Escribe en ella solo los
        datos
