...
@section('content')
  <div class="container mx-auto grid grid-cols-12 p-3 gap-3 text-black text-opacity-90">
    ...
    <div class="col-span-12 bg-white rounded shadow p-3 flex flex-col gap-3">
      <form action="{{ route('admin.divisions.import-students') }}" method="POST" id="form-user" enctype="multipart/form-data">
        @csrf
        <div class="flex flex-col gap-4 p-3">
          ...
          <div class="grid grid-cols-12 items-center">
            ...
            <select class="col-span-8 rounded h-full" name="period_id" required>
