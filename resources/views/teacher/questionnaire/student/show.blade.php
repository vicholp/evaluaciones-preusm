    ...
    <div class="col-span-12">
      <x-teacher.card.card>
        <div class="flex flex-col gap-4 p-6">
          <x-teacher.card.element :key="__('name')" :value="$student->name"></x-teacher.card.element>
          <x-teacher.card.element :key="__('questionnaire')" :value="$questionnaire->name"></x-teacher.card.element>
