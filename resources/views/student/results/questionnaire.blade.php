    ...
    <div class="col-span-12">
      <x-student.card.card>
        <x-student.card.list>
          ...
          <x-student.card.list-key-value :key="__('score')" :value="$student->stats()->getScoreInQuestionnaire($questionnaire)"/>
        </x-student.card.list>
      </x-student.card.card>
    </div>
    <div class="col-span-12">
        ...
        @foreach($questionnaire->questions as $question)
          <x-student.card.table-row>
            ...
            <div class="col-span-1 flex justify-center items-center">
              @if (Auth::user()->student->stats()->getScoreInQuestion($question))
